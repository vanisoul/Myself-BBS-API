...
- **端點**: `/api.php/provide/vod/?ac=list&wd={關鍵字}`
- **方法**: GET
- **功能**: 根據關鍵字搜尋視頻
...
```bash
curl "http://example.com/api.php/provide/vod/?ac=list&pg=1"
```

### 6.2 獲取特定分類的視頻

```bash
curl "http://example.com/api.php/provide/vod/?ac=list&t=1&pg=1"
```
...
```bash
curl "http://example.com/api.php/provide/vod/?ac=list&wd=復仇者聯盟"
```
